...
export SCRAPE_API_KEY="your_scrape_key"   # one key for Scrapingdog / LinkedIn scraper / ScraperAPI fallbacks
# Legacy (optional if SCRAPE_API_KEY is set): SCRAPINGDOG_API_KEY, LINKEDIN_SCRAPER_API_KEY, SCRAPERAPI_API_KEY
